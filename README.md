...
The final report can be found [here]([https://github.com/UBC-MDS/diabetes_prediction/blob/main/doc/diabetes_report.md](https://github.com/UBC-MDS/diabetes_prediction/blob/main/doc/diabetes_report.html))
