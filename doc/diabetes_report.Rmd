...
The f1 score for the tuned SVC model was `r test_results[[2,3]]` as opposed to `r test_results[[2,6]]` for the tuned logistic regression. When it comes to the recall scores, the SVC score was `r test_results[[2,4]]` compared to the `r test_results[[2,4]]` for logistic regression. The two models have the highest recall scores which limits the false negatives in predictions.
